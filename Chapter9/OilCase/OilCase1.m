...
%truth_realization = ISorted(3);
truth_realization=61;
...
for i = 1:num_injectors
    ...
    xlabel(['Injector ' num2str(i) ' Efficiency'],'fontsize',fontsize);
...
for i = 1:num_injectors
    subplot(2,2,i);
    scatter3(HarmonicScores(avail_real,1),HarmonicScores(avail_real,2),...
        PriorInjectorEfficiency(:,i),50,'filled');
    xlabel(['MPCA Component 1'],'fontsize',fontsize);
    ylabel(['MPCA Component 2'],'fontsize',fontsize);
    zlabel(['Injector ' num2str(i) ' Efficiency'],'fontsize',fontsize);
    set(gca,'fontsize',fontsize);
    axis tight; axis square;
    set(gcf,'color','w');
    
    hold on;
    plot3([HarmonicScores(truth_realization,1),HarmonicScores(truth_realization,1)],...
        [HarmonicScores(truth_realization,2),HarmonicScores(truth_realization,2)],...
        [0,1],'Linewidth',5);
end
